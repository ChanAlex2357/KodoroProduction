...
<%@ page import="mg.kodoro.models.production.FormuleProduction" %>
<%@ page import="mg.kodoro.models.production.FormuleProductionFille" %>
...
<section class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-8 bg-light p-4 rounded">
            ...
            <h3>Détails :</h3>
            <ul>
                <% for (FormuleProductionFille detail : formule.getDetailsFormule()) { %>
